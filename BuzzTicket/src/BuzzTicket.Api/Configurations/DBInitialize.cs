        ...
        public static void Initialize(DataContext context)
        {
            try
            {
                ...
                var tickets = new Ticket[]
                {
                    ...
                    new Ticket{ Solicitante ="Asuka", Aberto = true, Data = DateTime.Now.AddDays(-14), Solicitacao = "Melhorar conexao com a internet" },
                    ...
                    new Ticket{ Solicitante ="Moises", Aberto = true, Data = DateTime.Now.AddDays(-8), Solicitacao = "Melhorar conexao com a internet" },
                    ...
                    new Ticket{ Solicitante ="Jack", Aberto = false, Data = DateTime.Now.AddDays(-11), Solicitacao = "Melhorar conexao com a internet" },
